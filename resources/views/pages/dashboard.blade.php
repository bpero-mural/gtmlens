    ...
    <div class="space-y-6">
        ...
        <section class="grid gap-4 md:grid-cols-3">
            <x-ui.card>
                ...
                <p class="mt-2 text-2xl font-semibold">{{ app()->environment() }}</p>
            ...
            <x-ui.card>
                ...
                <p class="mt-2 text-2xl font-semibold">{{ config('queue.default') }}</p>
            ...
            <x-ui.card>
                ...
                <p class="mt-2 text-2xl font-semibold">{{ config('database.default') }}</p>
